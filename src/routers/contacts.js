...
import { contactSchema, partialContactSchema } from '../validation/contactValidation.js';
...
router.patch('/:contactId', validateBody(partialContactSchema), ctrlWrapper(updateContact));
